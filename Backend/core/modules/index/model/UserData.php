...
class UserData {
	...
	public function add(){
		$sql = "insert into ".self::$tablename." (name,lastname,username,is_dep,password,created_at) ";
		$sql .= "value (\"$this->name\",\"$this->lastname\",\"$this->username\",\"$this->dep\",\"$this->password\",$this->created_at)";
		Executor::doit($sql);
	}
