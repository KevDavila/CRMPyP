	...
	if($no_of_row > 0)
	{
		...
		foreach($result as $row)
		{
			if($row['user_email_status'] == 'not verified')
			{
				...
				if(isset($sub_result))
				{
					$message = '<label class="text-success">Gracias por registrarte<br />Puedes iniciar sesion aqui - <a href="login.php">Login</a></label>';
				}
			}
			else
			{
				$message = '<label class="text-info">Felicidades tu correo ha sido verificado</label>';
			}
		}
	}
	else
...
<html>
	...
	<body>
		...
		<div class="container">
			<h1 align="center">Playeras y Playeras</h1>
